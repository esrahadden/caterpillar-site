          ...
          <motion.div variants={staggerItem}>
            ...
            <ul className="space-y-3 text-gray-400 text-sm">
              <li className="flex items-start">
                <svg
                  className="w-5 h-5 mr-2 mt-0.5 text-purple-400 shrink-0"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
                ...
                <a href="mailto:samer@caterpillar-consulting.ai" className="hover:text-purple-400 transition">
              ...
              <li className="flex items-start">
                ...
                <a href="tel:+14049390628" className="hover:text-purple-400 transition">
                  (404) 939-0628
                </a>
              </li>
            </ul>
